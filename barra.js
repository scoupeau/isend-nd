...
var DialogLabels = {
    ferrom_caliente:'barra o strip en caliente',
    ferrom_hilofrio:'barra o strip en frio',
    Support: 'Support'
};
...
module.exports = [
    ...
    function (session) {
        ...
        builder.Prompts.choice(
            session,
            'Has elegido buscar una solución de NDT (No destructive Testing) para analizar defectos en producción en Barra. Dinos por favor si es laminado en caliente o en frío?',
