...
               body: [
                    {
                        "type": "TextBlock",
                        "text": "Solución para Defectos transversales en Frío para tu producto",
                        "size": "large",
                        "weight": "bolder"
                    },
                    {
                        "type": "TextBlock",
                        "text": "DEFdiscover es nuestra solución NDT para tu producto"
                    },
                    // {
                    //     "type": "TextBlock",
                ...
                "actions": [
                    {
                        "type": "Action.OpenUrl",
                        "method": "POST",
                        "url": "http://www.isend.es/es/soluciones/defdiscover",
                        "body": "DEFdiscover corrientes de inducción ",
                        "title": "Pulsa aqui para saber más de DEFdiscover"
                    },
                    {
                        "type": "Action.OpenUrl",
                        "method": "POST",
...
function hotelAsAttachment(soluciones) {
    return new builder.HeroCard()
        .title('HOTdiscover')
        .subtitle('Sistema NDT para detectar y mapear defectos puntuales en tiempo real')
        .images([new builder.CardImage().url('http://www.isend.es/images/piezas_320/pieza3_320.png')])
        .buttons([
            new builder.CardAction()
                .title('Pulsa aqui para ver más detalles')
                .type('openUrl')
