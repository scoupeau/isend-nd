...
var DialogLabels = {
    defpunto:'Defecto puntual en Sin Soldadura',
...
module.exports = [
    ...
    function (session) {
        ...
        builder.Prompts.choice(
            session,
            'Has elegido buscar una solucion de NDT para analizar defectos en producción de Tubos extruidos, sin Soldadura. ¿Qué defecto quieres detectar y mapear?',
